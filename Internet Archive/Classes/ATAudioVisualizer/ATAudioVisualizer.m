...
- (void) addEqualizerBars
{
    ...
    NSArray *values = [[NSArray alloc] initWithObjects:[NSNumber numberWithInt:30], [NSNumber numberWithInt:90], [NSNumber numberWithInt:200], [NSNumber numberWithInt:90], [NSNumber numberWithInt:30], [NSNumber numberWithInt:15], nil];
